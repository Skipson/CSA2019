public class ClocksV9 {
    ...
    public ClocksV9(String name, double input1, double input2)  {
        givenName = name;
        time1 = input1;
        time2 = input2;
        objDifference = 0.0;
    ...
    public double diffMinimum(double[] given)   {
    ...
    public double diffMaximum(double[] given)   {
    ...
    public double avgDifference(double[] given) {
        double total = 0.0;
        for(int i = 0; i < given.length; i++)   {
            double diff  = given[i];
            total += diff;
