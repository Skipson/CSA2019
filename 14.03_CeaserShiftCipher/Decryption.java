...
public class Decryption {
    ...
    public static void Decrypt()    {
        ...
        System.out.println("Decrypted Alphabet: " + alphabetString);
        System.out.println("");
        System.out.println("Please enter a phrase to be decrypted.");
        String inputPhrase = in.next();;
        System.out.println("Given Phrase: " + inputPhrase);
        System.out.println("Decrypted Phrase: " + Decryption.decryptShift(inputPhrase,shiftVal));
        System.out.println("");
    }

    // Actual decryption method
    public static String decryptShift(String given, int shiftVal) {
        String decrypted = "";
        int shiftAmnt = shift;
